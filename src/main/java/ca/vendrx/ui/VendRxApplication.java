...
public class VendRxApplication extends Application {
    ...
    private void initializeServices() {
        ...
        repository = new TransmissionRepository();
        ...
        vendRxService = new VendRxService(
                audioConfig,
                repository);

        vendRxService.setAudioMonitorListener(
                transmission -> Platform.runLater(
                        () -> transmissionTable
                                .getItems()
                                .add(0, transmission)));
    ...
    private SplitPane createTransmissionPanel() {
        ...
        Label title = new Label("Transmissions");

        transmissionTable = new TableView<>();
        ...
        TableColumn<Transmission, String> timeColumn = new TableColumn<>("Time");
        ...
        TableColumn<Transmission, Number> durationColumn = new TableColumn<>("Duration (s)");
        ...
        TableColumn<Transmission, Number> averageRmsColumn = new TableColumn<>("Avg RMS");
        ...
        TableColumn<Transmission, Number> maxRmsColumn = new TableColumn<>("Max RMS");
        ...
        TableColumn<Transmission, String> fileColumn = new TableColumn<>("File");
        ...
        transmissionTable
                ...
                .addListener(
                        (observable, oldValue, newValue) -> detailsPane.showTransmission(
                                newValue));
    ...
    private void loadAudioDevices() {
        ...
        List<Mixer.Info> devices = audioDeviceService
                .getInputDevices();
    ...
    private void loadTransmissions() {
        ...
        List<Transmission> transmissions = repository.findRecent(100);
    ...
    private void playSelectedTransmission() {
        ...
        Transmission transmission = transmissionTable
                .getSelectionModel()
                .getSelectedItem();
    ...
    private void deleteSelectedTransmission() {
        ...
        ButtonType result = confirmation
                .showAndWait()
                .orElse(
                        ButtonType.CANCEL);
